...
public class ModComponents {
    ...
    public static void registerAll() {
        ...
        ComponentRegistry.register(new ResourceLocation(MagicalIndustryMod.MOD_ID, "item_input"), ItemInputComponent::new);
        ComponentRegistry.register(new ResourceLocation(MagicalIndustryMod.MOD_ID, "item_output"), ItemOutputComponent::new);
